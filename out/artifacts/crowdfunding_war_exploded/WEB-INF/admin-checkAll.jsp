...
<head>
    ...
    <script type="text/javascript">
        ...
        function pageSelectCallback(pageIndex,jQuery){
            ...
            //     跳转页面
            window.location.href="admin/checkAll?pageNum="+pageNum+"&keyword=${param.keyword}";
                ...
                <ul style="padding-left:0px;" class="list-group">
                    ...
                    <li class="list-group-item">
                        ...
                        <ul style="margin-top:10px;">
                            ...
                            <li style="height:30px;">
                                <a href="admin/checkAll" style="color:red"> 项目管理</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-inline" role="form" style="float:left;" method="post" action="admin/checkAll">
                            ...
                            <C:if test="${!empty pageInfo.list}">
                                <c:forEach items="${pageInfo.list}" var="project" varStatus="myStatus">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="admin/delete/${project.projectName}/${pageInfo.pageNum}" class="btn btn-danger btn-xs">删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </C:if>
