        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-inline" role="form" style="float:left;" method="post" action="admin/showUser">
                    ...
                    <a href="admin/add" class="btn btn-info" style="float: right;margin-left: 10px">新增</a>
                    <br>
                    <hr style="clear:both;">
                    <div class="table-responsive">
                        <table class="table  table-bordered">
                            ...
                            <C:if test="${empty pageInfo.list}">
                                <tr>
                                    <td colspan="4" align="center">抱歉，没有查询到数据</td>
                                </tr>
                            </C:if>
                            <C:if test="${!empty pageInfo.list}">
                                <c:forEach items="${pageInfo.list}" var="user" varStatus="myStatus">
                                    <p hidden="hidden">${user.id}</p>
                                    <tr>
                                        <td>${user.account}</td>
                                        <td>${user.email}</td>
                                        <td>${user.createTime}</td>
                                        <td>
                                            <a href="admin/edit/${user.account}/${pageInfo.pageNum}" class="btn btn-primary btn-xs">修改</a>
                                            <a href="admin/remove/${user.account}/${pageInfo.pageNum}" class="btn btn-danger btn-xs">删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </C:if>
